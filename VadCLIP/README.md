...
```python
python src/pipeline_vadclip_internvl35.py   --feature-path /root/autodl-tmp/UCFClipFeature/UCFClipFeatures/Explosion/Explosion001_x264__5.npy   --vadclip-ckpt /root/VadCLIP/model_ucf.pth   --internvl-path /root/autodl-tmp/InternVL3_5-8B   --select-frames 36 --weight 0.5 --window-size 12

python src/pipeline_vadclip_qwen3vl.py   --feature-path /root/autodl-tmp/UCFClipFeature/UCFClipFeatures/Explosion/Explosion001_x264__5.npy   --vadclip-ckpt /root/VadCLIP/model_ucf.pth   --qwen-path /root/autodl-tmp/Qwen3-VL-8B-Instruct   --select-frames 36 --weight 0.5 --window-size 12

python src/test_vadclip_internvl35_auc.py --test-list /root/VadCLIP/list/ucf_CLIP_rgbtest.csv --gt-path /root/VadCLIP/list/gt_ucf.npy --internvl-path /root/autodl-tmp/InternVL3_5-8B --weight 0.5 --window-size 12 --select-frames 36 --vadclip-ckpt /root/VadCLIP/model_ucf.pth

python src/test_vadclip_internvl35_auc.py --test-list /root/VadCLIP/list/ucf_CLIP_rgbtest.csv --gt-path /root/VadCLIP/list/gt_ucf.npy --internvl-path /root/HolmesVAU/ckpt/HolmesVAU-2B --weight 0.5 --window-size 12 --select-frames 36 --vadclip-ckpt /root/VadCLIP/model_ucf.pth

python src/test_vadclip_internvl35_auc.py --test-list /root/VadCLIP/list/xd_CLIP_rgbtest.csv --gt-path /root/VadCLIP/list/gt.npy --internvl-path /root/autodl-tmp/InternVL3_5-2B --weight 0.5 --window-size 8 --select-frames 16 --vadclip-ckpt /root/VadCLIP/model_xd.pth

python src/test_vadclip_qwen3vl_auc.py   --test-list /root/VadCLIP/list/ucf_CLIP_rgbtest.csv   --gt-path /root/VadCLIP/list/gt_ucf.npy   --qwen-path /root/autodl-tmp/Qwen3-VL-8B-Instruct  --weight 0.5 --window-size 12 --select-frames 36 --vadclip-ckpt /root/VadCLIP/model_ucf.pth

python src/test_vadclip_qwen3vl_auc.py   --test-list /root/VadCLIP/list/xd_CLIP_rgbtest.csv   --gt-path /root/VadCLIP/list/gt.npy   --qwen-path /root/autodl-tmp/Qwen3-VL-8B-Instruct  --weight 0.5 --window-size 8 --select-frames 16 --vadclip-ckpt /root/VadCLIP/model_xd.pth

python src/test_ats_qwen3vl_auc.py --test-list /root/VadCLIP/list/ucf_CLIP_rgbtest.csv --qwen-path /root/autodl-tmp/Qwen3-VL-8B-Instruct  --weight 0.5 --window-size 12 --select-frames 36

python src/test_ats_qwen3vl_auc.py --test-list /root/VadCLIP/list/ucf_CLIP_rgbtest.csv --qwen-path /root/autodl-tmp/Qwen3-VL-8B-Instruct  --weight 0.5 --window-size 12 --select-frames 36 --benchmark --warmup 1 --repeat 3
