...
try:
    from pipeline_ats_internvl35 import build_pipeline
except ImportError:
...
def infer_ucf_video_path(sample_path: str, label: str, video_root: str) -> str:
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate ATS + InternVL3.5 AUC')
    ...
    parser.add_argument('--save-json', type=str, default='/root/results/ucf_crime_results_ats_internvl35.json')
